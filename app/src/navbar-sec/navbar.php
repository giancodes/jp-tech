            ...
            <nav class="px-2 navbar navbar-expand-lg">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="homeNav nav-link active" aria-current="page"><svg
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                    fill="currentColor" class="bi bi-hand-index-fill" viewBox="0 0 16 16">
                                    <path
                    ...
                    <form class="d-flex mb-0" role="search">
                        ...
                        txt.innerHTML = split_name[0];
                                    ...
                                    ?>
                        <button class="btn mx-1 btn-log"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                fill="currentColor" class="bi bi-door-open-fill" viewBox="0 0 16 16">
                                <path
                                    d="M1.5 15a.5.5 0 0 0 0 1h13a.5.5 0 0 0 0-1H13V2.5A1.5 1.5 0 0 0 11.5 1H11V.5a.5.5 0 0 0-.57-.495l-7 1A.5.5 0 0 0 3 1.5V15H1.5zM11 2h.5a.5.5 0 0 1 .5.5V15h-1V2zm-2.5 8c-.276 0-.5-.448-.5-1s.224-1 .5-1 .5.448.5 1-.224 1-.5 1z" />
                            </svg> Log In</button><?php
                                    }
                                    ?>
            ...
            <div class=" offcanvas offcanvas-end" tabindex="-1" id="offcanvasNavbar"
                ...
                <div class="offcanvas-body bg-secondary">
                    ...
                    <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                        <li class="nav-item">
                            <a class="nav-link" aria-current="page" href="../index/mainsection.php">
                                <i class="fa-solid fa-house"></i> Home </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../menu/services.php">
                                <i class="fa-solid fa-bars-progress"></i> Services </a>
                        </li>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../menu/team.php">
                                <i class="fa-solid fa-briefcase"></i> Our Team </a>
                        </li>
                        </li>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../menu/about.php">
                                <i class="fa-solid fa-address-card"></i> About </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../menu/contactus.php">
                                <i class="fa-solid fa-id-badge"></i> Contact </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="../shoping_system/My_cart.php">
                        ...
                        txt.innerHTML = split_name[0];
                            ...
                            <button type="button" class="btn btn-light float-end" data-bs-toggle="modal"
                                data-bs-target="#staticBackdrop"> Login/SignUp </button>
                        </li> <?php
                                    }
                                    ?>
                    </ul>
