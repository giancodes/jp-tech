...
<head>
    <meta charset="UTF-8">
    <link rel="stylesheet" href="../navbar-sec/navbar.css">
...
<body>
    <div class="container">
        <div class="heading">
            <h1>Our Services</h1>
            <hr>
            <p>Welcome to our site, <b>ShopMe</b></p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="collapse" id="replacement">
                                <p class="card-text">
                                    ...
                                    possible,
                                    which is why we take great pride in offering an "Easy Replacement" policy. We
                                    understand that
                                    sometimes, despite the best efforts, a product may not meet your expectations.
                                </p>
                            </div>
                        </div>
                    </div>
